    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header mt-3">
                <h4 class="card-title">Form Edit Matakuliah</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <form action="/dashboard/matakuliah/{{ $matakuliah->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="kode_mk" id="kode_mk" 
                                        ...
                                        placeholder="Enter kode matakuliah" required value="{{ old('kode_mk', $matakuliah->kode_mk) }}">
                                        @error ('kode_mk')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="mk" id="mk" 
                                        ...
                                        placeholder="Enter matakuliah" required value="{{ old('mk', $matakuliah->mk) }}">
                                        @error ('mk')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="sks" id="sks" 
                                        ...
                                        placeholder="Enter jumlah sks" required value="{{ old('sks', $matakuliah->sks) }}">
                                        @error ('sks')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
