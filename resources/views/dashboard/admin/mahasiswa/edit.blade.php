            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <form action="/dashboard/mahasiswa/{{ $mahasiswa->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="username" id="username" 
                                            ...
                                            placeholder="Enter username" required value="{{ old('username',  $mahasiswa->user->username) }}">
                                            @error ('username')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" name="email" id="email" 
                                            ...
                                            placeholder="Enter email" required value="{{ old('email', $mahasiswa->user->email) }}">
                                            @error ('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="nim" id="nim" 
                                            ...
                                            placeholder="Enter nim" required value="{{ old('nim',  $mahasiswa->nim) }}">
                                            @error ('nim')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="nama" id="nama" 
                                            ...
                                            placeholder="Enter nama" required value="{{ old('nama',  $mahasiswa->nama) }}">
                                            @error ('nama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="form-check-primary mb-4 mt-3">
                                            <div class="form-check form-check-inline">
                                                ...
                                                @error('jns_kelamin') is-invalid @enderror" value="Laki-Laki" {{
                                                    old('jns_kelamin',  $mahasiswa->jns_kelamin)=='Laki-Laki' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                @error('jns_kelamin') is-invalid @enderror" value="Perempuan" {{
                                                    old('jns_kelamin',  $mahasiswa->jns_kelamin)=='Perempuan' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="tmpt_lahir" id="tmpt_lahir" 
                                            ...
                                            placeholder="Enter tempat lahir" required value="{{ old('tmpt_lahir',  $mahasiswa->tmpt_lahir) }}">
                                            @error ('tmpt_lahir')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="tgl_lahir" id="tgl_lahir" 
                                            ...
                                            placeholder="Enter tanggal lahir" required value="{{ old('tgl_lahir',  $mahasiswa->tgl_lahir) }}">
                                            @error ('tgl_lahir')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="alamat" id="alamat" 
                                        ...
                                        placeholder="Enter alamat" required value="{{ old('alamat',  $mahasiswa->alamat) }}">
                                        @error ('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
